...
def calc(event=None):
    ...
    subject = (english, math, ict, filipino, science, social_studies, pe)



    Average = (english + math + ict + filipino + science + social_studies + pe) /20
    ...
    <div class="result-card">
      ...
      <div class="result-box">
        ...
        ICT: {ict_raw}<br>
        PE: {pe_raw}<br>
        Social Studies: {social_studies_raw}<br>
        Status: {status}
      </div>
    </div>
